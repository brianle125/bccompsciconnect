...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, TopBarComponent, UserEditComponent],
...
export class UserProfileComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.userService.getUser(username).subscribe((data) => {
      ...
      this.userData = new UserProfileData(this.user[0].username, 'assets/user.png', this.user[0].email, this.user[0].description)
    })
